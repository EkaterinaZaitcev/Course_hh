...
def test_sort_vacancies_by_salary(vacancies_objects):
    ...
    assert res[0].name == "Программист"
    assert res[3].name == "Программист1"


def test_sort_vacancies_by_salary_same_salary():
    vacs = [
        Vacancy("Программист", "https://hh", "требования", "обязанности", 100000),
        Vacancy("Программист2", "https://hh2", "требования 2", "обязанности 2", 100000),
        Vacancy("Программист1", "https://hh1", "требования 1", "обязанности 1", 10000),
    ]
...
def test_get_top_vacancies(vacancies_objects):
    ...
    assert res == [
        Vacancy("Программист", "https://hh", "требования", "обязанности", 100000),
        Vacancy("Программист2", "https://hh", "требования 2", "обязанности 2", 50000),
    ]
